...
Program: UseButtonsAndLedsP1.java          Last Date of this Revision: June 9, 2022

Purpose: An application to make the LEDs turn off when each button is pressed and stay on when it is not pressed. 
...
public class UseButtonsAndLedsP1 {
